...
void pgeRippleSprite::onEnterTransitionDidFinish()
{
	...
	listener1->onTouchBegan = CC_CALLBACK_2(pgeRippleSprite::ccTouchBegan, this);
	listener1->onTouchCancelled = CC_CALLBACK_2(pgeRippleSprite::ccTouchCancelled, this);
	listener1->onTouchEnded = CC_CALLBACK_2(pgeRippleSprite::ccTouchEnded, this);
	//listener1->onTouchMoved = CC_CALLBACK_2(pgeRippleSprite::ccTouchMoved, this);
